...
- (void)viewDidLoad {
    [super viewDidLoad];
    apiArray = [NSArray arrayWithObjects:@"Authenticate",@"Authenticate - Social Media",@"GetPanels",@"GetSurveys",@"Forgot password",@"Change Password",@"Download Media",@"Upload Media",@"GetPanellistProfile",@"UpdatePanellistProfile",@"GetCountries",@"Geofencing", @"Take Demo", nil];

...
class GetScriptViewController: UIViewController, UITextFieldDelegate
{
    ...
    @IBAction func getScript(_ sender: AnyObject)
    {
        ...
        {
            let alertController = UIAlertController(title: "OPGSDKv1.4", message: "Script Download Successful!", preferredStyle: .alert)
        ...
        {
            let alertController = UIAlertController(title: "OPGSDKv1.4", message: "Script Download Failed!", preferredStyle: .alert)

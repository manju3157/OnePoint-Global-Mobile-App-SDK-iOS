...
class DownloadMediaViewController: UIViewController, UITextFieldDelegate
{
    ...
    @IBAction func downloadMedia(_ sender: AnyObject)
    {
        ...
        {
            let alertController = UIAlertController(title: "OPGSDKv1.4", message: "Media Download Successful!", preferredStyle: .alert)
        ...
        {
            let alertController = UIAlertController(title: "OPGSDKv1.4", message: "Media Download Failed!", preferredStyle: .alert)

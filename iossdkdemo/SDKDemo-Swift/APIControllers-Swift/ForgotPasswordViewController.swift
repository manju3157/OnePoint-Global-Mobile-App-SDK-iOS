...
class ForgotPasswordViewController: UIViewController, UITextFieldDelegate
{
    ...
    @IBAction func forgotPass(_ sender: AnyObject)
    {
        ...
        {
            let alertController = UIAlertController(title: "OPGSDKv1.4", message: "Mail Sent Successfully", preferredStyle: .alert)
        ...
        {
            let alertController = UIAlertController(title: "OPGSDKv1.4", message: "Mail Sending Failed", preferredStyle: .alert)
